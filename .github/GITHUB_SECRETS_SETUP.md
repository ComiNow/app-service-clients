...
1. Ve a tu repositorio en GitHub: `https://github.com/ComiNow/app-service-clients`
...
Valor: [Tu Access Key ID del usuario IAM github-actions-cominow-client]
```
...
Valor: [Tu Secret Access Key del usuario IAM github-actions-cominow-client]
```
...
- [ ] ✅ AWS_S3_BUCKET configurado (cominow-client-prod)
...
- Revisa que el usuario IAM tenga la política `cominow-client-deploy-policy` adjunta
